...
export default function DetailsPageSkeleton() {
  return (
    <Card className="m-0 mx-auto min-h-screen w-full bg-background p-0 md:min-h-[calc(100vh-4rem)] md:p-6">
      ...
      <Separator />
      {/* ## Cabeçalho do Card ## */}
      <div className="mt-4 flex flex-col rounded-md border border-foreground/15 p-6">
        <div className="flex items-center">
          <div className="mt-4 flex w-full items-center justify-between gap-4 space-y-2">
