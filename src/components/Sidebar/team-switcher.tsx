...
export function TeamSwitcher(corp ?: { corp: IOrganizacaoSchema }) {
  ...
  return (
      <SidebarMenu>
        <SidebarMenuItem>
          <SidebarGroupLabel>Corporação Selecionada</SidebarGroupLabel>
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">{corp?.corp?.short_name_corp}</span>
            ...
            >
              ...
              >
                <div className="flex size-6 items-center justify-center rounded-sm border ">
                  <Avatar className="h-8 w-8 rounded-lg gap-2">
                    <AvatarImage
                        src={
                          process.env.NEXT_PUBLIC_API_GSO !== undefined &&
                          corp?.corp?.image !== undefined ?
