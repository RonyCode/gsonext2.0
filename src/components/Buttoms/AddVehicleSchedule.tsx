    ...
    >
      <div className={` relative h-full w-full`}>
        <div className=" grid place-content-center hover:z-0 md:h-full  ">
          ...
          <div
            className={`mt-32 grid h-[400px] w-[200px] grid-cols-2 
            place-content-center gap-x-2 overflow-hidden rounded-xl 
            p-0 md:ml-[2px] md:mt-20  md:h-[210px] md:w-[140px]`}
          >
            {' '}
                    ...
                    >
                      <div className="hover:stroker-primary relative">
                        ...
                        {item?.member?.image !== undefined && (
                          <Avatar
                            className=" absolute top-0 h-full w-full border-[3px] p-[2px] hover:border-primary"
                          >
                            <AvatarImage
                              src={
