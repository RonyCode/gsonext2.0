        ...
        return (
          <>
            <div className="flex w-full items-center text-[0.8500rem] text-muted-foreground">
              <Avatar className="flex h-14 w-14 items-center justify-center rounded-full shadow-sm shadow-foreground transition-all duration-300 hover:scale-[140%] md:h-16 md:w-16">
                <AvatarImage
