...
const BannerHome1 = (): ReactElement => {
  ...
  return (
    <div
      className={`center transform transition-all duration-1000 ease-out ${shouldHide ? "pointer-events-none opacity-0" : isVisible ? "opacity-100" : "opacity-30"} fixed h-full w-full bg-no-repeat brightness-75 md:grid md:w-[80vw] md:grid-cols-2 md:place-content-center md:place-items-center md:bg-cover`}
      style={{
