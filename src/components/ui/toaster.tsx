              ...
              {title !== null && (
                <ToastTitle
                  className={`border-b border-[#1DA12A] ${
                    ...
                    (variant === "alert" && "border-blue-500 text-blue-500") ||
                    (variant === "default" &&
              ...
              {description !== null && (
                <div className="mt-2 flex w-[340px] items-center rounded-md p-4 py-2">
                  <div className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-green-100 text-green-500 dark:bg-green-800 dark:text-green-200">
                    ...
                    {variant === "default" && (
                      <div className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-secondary text-foreground dark:bg-secondary dark:text-foreground">
                        <svg
                          className="h-5 w-5"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    {variant === "alert" && (
                      <div className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100 text-blue-500 dark:bg-blue-700 dark:text-blue-200">
                        <svg
                          className="h-5 w-5"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
